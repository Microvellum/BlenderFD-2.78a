...
def unregister():
    ...
    space_fluid_text.unregister()
    space_fluid_info.unregister()
    space_fluid_view3d.unregister()
    space_fluid_view3d_tools_panel.unregister()